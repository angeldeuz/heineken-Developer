...
@Component({
  selector: 'app-grafica-bbe',
  templateUrl: './grafica-bbe.component.html',
  styleUrls: ['./grafica-bbe.component.sass'],
  encapsulation: ViewEncapsulation.None,
  })
export class GraficaBbeComponent {
  private chart: am4charts.XYChart;


  constructor(private zone: NgZone, private TarjetaBbeReporteoService: TarjetaBbeReporteoService) { }
  ...
  ngAfterViewInit() {
    ...
    this.TarjetaBbeReporteoService.getAllTableData()
      .then(resultService => {
